...
export class UserListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.newTableSubscription = this.userService.getUsers().subscribe((res) => {
  ...
  ngOnDestroy(): void {
    // Unsubscribe from the newTable subscription to avoid memory leaks
    if (this.newTableSubscription) {
      this.newTableSubscription.unsubscribe();
    }
  }
  /**
